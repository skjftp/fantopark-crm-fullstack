  ...
  return React.createElement('div', { 
    ...
    React.createElement('div', { 
      ...
      React.createElement('form', { onSubmit: handleInventoryFormSubmit },
        // NEW: Just add this info box at the top
        React.createElement('div', { className: 'bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mb-6' },
          React.createElement('h3', { className: 'text-sm font-semibold text-blue-800 dark:text-blue-200 mb-2' }, 
            '🎉 Coming Soon: Multiple Ticket Categories!'
          ),
          React.createElement('p', { className: 'text-sm text-blue-700 dark:text-blue-300' },
            'Soon you\'ll be able to add multiple ticket categories (General, Premium, VIP, etc.) for a single event instead of creating separate inventory items.'
          )
        ),
